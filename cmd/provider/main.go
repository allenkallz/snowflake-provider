...
func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "Snowflake support for Crossplane.").DefaultEnvars()
	...
	kingpin.FatalIfError(snowflake.Setup(mgr, o), "Cannot setup Snowflake controllers")
